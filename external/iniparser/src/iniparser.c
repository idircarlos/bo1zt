 ...
 */
/*--------------------------------------------------------------------------*/
static const char * xstrcpy(const char * in, char *out, unsigned len)
{
    unsigned i ;
...
const char * iniparser_getstring(const dictionary * d, const char * key, const char * def)
{
    ...
    lc_key = xstrcpy(key, tmp_str, sizeof(tmp_str));
...
int iniparser_set(dictionary * ini, const char * entry, const char * val)
{
    ...
    return dictionary_set(ini, xstrcpy(entry, tmp_key, sizeof(tmp_key)), val);
}
...
{
    char tmp_str[ASCIILINESZ+1];
    dictionary_unset(ini, xstrcpy(entry, tmp_str, sizeof(tmp_str)));
}
